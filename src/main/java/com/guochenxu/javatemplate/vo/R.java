package com.guochenxu.javatemplate.vo;
...
public class R<T> implements Serializable {
    ...
    public static <T> R<T> error() {
        return new R<>(HttpCode.FAIL, "执行失败", null);
    }

    public static <T> R<T> error(String _msg) {
        return new R<>(HttpCode.FAIL, _msg, null);
    }


    public static <T> R<T> error(T _data) {
        return new R<>(HttpCode.FAIL, "执行失败", _data);
    }

    public static <T> R<T> error(String _msg, T _data) {
        return new R<>(HttpCode.FAIL, _msg, _data);
    }
